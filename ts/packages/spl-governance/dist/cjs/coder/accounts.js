...
exports.SplGovernanceAccountsCoder = void 0;
// @ts-nocheck
const B = __importStar(require("@native-to-anchor/buffer-layout"));
class SplGovernanceAccountsCoder {
    constructor(_idl) { }
...
exports.SplGovernanceAccountsCoder = SplGovernanceAccountsCoder;
function decodeRealmV2Account(ix) {
    return REALM_V2_LAYOUT.decode(ix);
}
function decodeProposalV2Account(ix) {
    return PROPOSAL_V2_LAYOUT.decode(ix);
}
function decodeProgramMetadataAccount(ix) {
    return PROGRAM_METADATA_LAYOUT.decode(ix);
}
function decodeSignatoryRecordV2Account(ix) {
    return SIGNATORY_RECORD_V2_LAYOUT.decode(ix);
}
function decodeRealmV1Account(ix) {
    return REALM_V1_LAYOUT.decode(ix);
}
function decodeTokenOwnerRecordV1Account(ix) {
    return TOKEN_OWNER_RECORD_V1_LAYOUT.decode(ix);
}
function decodeGovernanceV1Account(ix) {
    return GOVERNANCE_V1_LAYOUT.decode(ix);
}
function decodeProposalV1Account(ix) {
    return PROPOSAL_V1_LAYOUT.decode(ix);
}
function decodeSignatoryRecordV1Account(ix) {
    return SIGNATORY_RECORD_V1_LAYOUT.decode(ix);
}
function decodeVoteRecordV1Account(ix) {
    return VOTE_RECORD_V1_LAYOUT.decode(ix);
}
function decodeGovernanceV2Account(ix) {
    return GOVERNANCE_V2_LAYOUT.decode(ix);
}
function decodeVoteRecordV2Account(ix) {
    return VOTE_RECORD_V2_LAYOUT.decode(ix);
}
function decodeTokenOwnerRecordV2Account(ix) {
    return TOKEN_OWNER_RECORD_V2_LAYOUT.decode(ix);
}
function decodeRealmConfigAccountAccount(ix) {
    return REALM_CONFIG_ACCOUNT_LAYOUT.decode(ix);
}
function decodeProposalTransactionV2Account(ix) {
    return PROPOSAL_TRANSACTION_V2_LAYOUT.decode(ix);
}
const REALM_V2_LAYOUT = B.struct([
    ((p) => {
...
const PROPOSAL_V2_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const PROGRAM_METADATA_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const SIGNATORY_RECORD_V2_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const REALM_V1_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const TOKEN_OWNER_RECORD_V1_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const GOVERNANCE_V1_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const PROPOSAL_V1_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const SIGNATORY_RECORD_V1_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const VOTE_RECORD_V1_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const GOVERNANCE_V2_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const VOTE_RECORD_V2_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const TOKEN_OWNER_RECORD_V2_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const REALM_CONFIG_ACCOUNT_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
...
const PROPOSAL_TRANSACTION_V2_LAYOUT = B.struct([
    ((p) => {
        const U = B.union(B.u8("discriminator"), null, p);
        U.addVariant(0, B.struct([]), "uninitialized");
        U.addVariant(1, B.struct([]), "realmV1");
