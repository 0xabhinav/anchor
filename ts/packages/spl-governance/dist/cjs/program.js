...
exports.splGovernanceProgram = void 0;
const web3_js_1 = require("@solana/web3.js");
const anchor_1 = require("@coral-xyz/anchor");
const coder_1 = require("./coder");
const SPL_GOVERNANCE_PROGRAM_ID = web3_js_1.PublicKey.default;
function splGovernanceProgram(params) {
    var _a;
    return new anchor_1.Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : SPL_GOVERNANCE_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new coder_1.SplGovernanceCoder(IDL));
}
exports.splGovernanceProgram = splGovernanceProgram;
const IDL = {
    version: "3.0.0",
    name: "spl_governance",
    instructions: [
