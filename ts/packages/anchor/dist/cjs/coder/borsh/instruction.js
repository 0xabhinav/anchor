...
class BorshInstructionCoder {
    ...
    encode(ixName, ix, discriminator) {
        return this._encode(ixName, ix, discriminator !== null && discriminator !== void 0 ? discriminator : sighash(exports.SIGHASH_GLOBAL_NAMESPACE, ixName));
    }
    ...
    decode(ix, encoding = "hex", ixName) {
        ...
        let sighashKey = bs58_1.default.encode(ixName ? sighash(exports.SIGHASH_GLOBAL_NAMESPACE, ixName) : ix.slice(0, 8));
        let data = ix.slice(8);
        ...
        switch (typeDef.type.kind) {
            ...
            case "enum": {
                ...
                if (typeDef.type.variants[0].name) {
                    ...
                    const camelCaseVariant = (0, camelcase_1.default)(variant);
                    const enumVariant = variants.find((v) => (0, camelcase_1.default)(v.name) === camelCaseVariant);
                    if (!enumVariant) {
                    ...
                    const namedFields = Object.keys(enumType)
                        ...
                        const camelCaseField = (0, camelcase_1.default)(f);
                        const idlField = fields.find((v) => (0, camelcase_1.default)(v.name) === camelCaseField);
                        if (!idlField) {
