...
type SplInterface = "spl_transfer_hook_interface::initialize_extra_account_metas" | "spl_transfer_hook_interface::execute";
export declare class MethodsBuilder<IDL extends Idl, I extends AllInstructions<IDL>> {
    ...
    interface(splInterface: SplInterface): MethodsBuilder<IDL, I>;
