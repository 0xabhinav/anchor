...
exports.splTokenSwapProgram = exports.SPL_TOKEN_SWAP_PROGRAM_ID = void 0;
const web3_js_1 = require("@solana/web3.js");
const anchor_1 = require("@coral-xyz/anchor");
const coder_1 = require("./coder");
exports.SPL_TOKEN_SWAP_PROGRAM_ID = new web3_js_1.PublicKey("SwapsVeCiPHMUAtzQWZw7RjsKjgCjhwU55QGu4U1Szw");
function splTokenSwapProgram(params) {
    var _a;
    return new anchor_1.Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : exports.SPL_TOKEN_SWAP_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new coder_1.SplTokenSwapCoder(IDL));
}
exports.splTokenSwapProgram = splTokenSwapProgram;
const IDL = {
    version: "3.0.0",
    name: "spl_token_swap",
    instructions: [
