...
export const SPL_TOKEN_SWAP_PROGRAM_ID = new PublicKey("SwapsVeCiPHMUAtzQWZw7RjsKjgCjhwU55QGu4U1Szw");
export function splTokenSwapProgram(params) {
    var _a;
    return new Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : SPL_TOKEN_SWAP_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new SplTokenSwapCoder(IDL));
}
const IDL = {
    version: "3.0.0",
    name: "spl_token_swap",
