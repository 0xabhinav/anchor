...
export declare const SPL_TOKEN_SWAP_PROGRAM_ID: PublicKey;
interface GetProgramParams {
    programId?: PublicKey;
    provider?: AnchorProvider;
}
export declare function splTokenSwapProgram(params?: GetProgramParams): Program<SplTokenSwap>;
declare type SplTokenSwap = {
    version: "3.0.0";
    name: "spl_token_swap";
    instructions: [
        {
