...
export declare const SPL_BINARY_OPTION_PROGRAM_ID: PublicKey;
interface GetProgramParams {
    programId?: PublicKey;
    provider?: AnchorProvider;
}
export declare function splBinaryOptionProgram(params?: GetProgramParams): Program<SplBinaryOption>;
declare type SplBinaryOption = {
    version: "0.1.0";
