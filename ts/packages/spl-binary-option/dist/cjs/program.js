...
exports.splBinaryOptionProgram = exports.SPL_BINARY_OPTION_PROGRAM_ID = void 0;
const web3_js_1 = require("@solana/web3.js");
const anchor_1 = require("@coral-xyz/anchor");
const coder_1 = require("./coder");
exports.SPL_BINARY_OPTION_PROGRAM_ID = new web3_js_1.PublicKey("betw959P4WToez4DkuXwNsJszqbpe3HuY56AcG5yevx");
function splBinaryOptionProgram(params) {
    var _a;
    return new anchor_1.Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : exports.SPL_BINARY_OPTION_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new coder_1.SplBinaryOptionCoder(IDL));
}
exports.splBinaryOptionProgram = splBinaryOptionProgram;
const IDL = {
    version: "0.1.0",
