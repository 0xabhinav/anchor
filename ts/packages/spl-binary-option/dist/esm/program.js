...
export const SPL_BINARY_OPTION_PROGRAM_ID = new PublicKey("betw959P4WToez4DkuXwNsJszqbpe3HuY56AcG5yevx");
export function splBinaryOptionProgram(params) {
    var _a;
    return new Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : SPL_BINARY_OPTION_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new SplBinaryOptionCoder(IDL));
}
const IDL = {
    version: "0.1.0",
