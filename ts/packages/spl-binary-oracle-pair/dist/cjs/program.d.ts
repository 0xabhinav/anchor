...
export declare const SPL_BINARY_ORACLE_PAIR_PROGRAM_ID: PublicKey;
interface GetProgramParams {
    programId?: PublicKey;
    provider?: AnchorProvider;
}
export declare function splBinaryOraclePairProgram(params?: GetProgramParams): Program<SplBinaryOraclePair>;
declare type SplBinaryOraclePair = {
    version: "0.1.0";
