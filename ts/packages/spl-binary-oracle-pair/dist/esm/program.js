...
export const SPL_BINARY_ORACLE_PAIR_PROGRAM_ID = new PublicKey("Fd7btgySsrjuo25CJCj7oE7VPMyezDhnx7pZkj2v69Nk");
export function splBinaryOraclePairProgram(params) {
    var _a;
    return new Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : SPL_BINARY_ORACLE_PAIR_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new SplBinaryOraclePairCoder(IDL));
}
const IDL = {
    version: "0.1.0",
