...
export const SPL_TOKEN_LENDING_PROGRAM_ID = new PublicKey("FJAwitEMXUEUibVHXXwpikL7Ct1xTujaY2XMtccUBSoK");
export function splTokenLendingProgram(params) {
    var _a;
    return new Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : SPL_TOKEN_LENDING_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new SplTokenLendingCoder(IDL));
}
const IDL = {
    version: "0.2.0",
