...
exports.splTokenLendingProgram = exports.SPL_TOKEN_LENDING_PROGRAM_ID = void 0;
const web3_js_1 = require("@solana/web3.js");
const anchor_1 = require("@coral-xyz/anchor");
const coder_1 = require("./coder");
exports.SPL_TOKEN_LENDING_PROGRAM_ID = new web3_js_1.PublicKey("FJAwitEMXUEUibVHXXwpikL7Ct1xTujaY2XMtccUBSoK");
function splTokenLendingProgram(params) {
    var _a;
    return new anchor_1.Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : exports.SPL_TOKEN_LENDING_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new coder_1.SplTokenLendingCoder(IDL));
}
exports.splTokenLendingProgram = splTokenLendingProgram;
const IDL = {
    version: "0.2.0",
