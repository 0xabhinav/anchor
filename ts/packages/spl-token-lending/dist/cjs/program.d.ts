...
export declare const SPL_TOKEN_LENDING_PROGRAM_ID: PublicKey;
interface GetProgramParams {
    programId?: PublicKey;
    provider?: AnchorProvider;
}
export declare function splTokenLendingProgram(params?: GetProgramParams): Program<SplTokenLending>;
declare type SplTokenLending = {
    version: "0.2.0";
