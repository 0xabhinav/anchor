...
export declare const SPL_STAKE_POOL_PROGRAM_ID: PublicKey;
interface GetProgramParams {
    programId?: PublicKey;
    provider?: AnchorProvider;
}
export declare function splStakePoolProgram(params?: GetProgramParams): Program<SplStakePool>;
declare type SplStakePool = {
    version: "0.7.0";
    name: "spl_stake_pool";
    instructions: [
        {
