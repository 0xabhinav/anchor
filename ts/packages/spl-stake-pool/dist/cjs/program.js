...
exports.splStakePoolProgram = exports.SPL_STAKE_POOL_PROGRAM_ID = void 0;
const web3_js_1 = require("@solana/web3.js");
const anchor_1 = require("@coral-xyz/anchor");
const coder_1 = require("./coder");
exports.SPL_STAKE_POOL_PROGRAM_ID = new web3_js_1.PublicKey("SPoo1Ku8WFXoNDMHPsrGSTSG1Y47rzgn41SLUNakuHy");
function splStakePoolProgram(params) {
    var _a;
    return new anchor_1.Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : exports.SPL_STAKE_POOL_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new coder_1.SplStakePoolCoder(IDL));
}
exports.splStakePoolProgram = splStakePoolProgram;
const IDL = {
    version: "0.7.0",
    name: "spl_stake_pool",
    instructions: [
