...
export function splStakePoolProgram(params) {
    var _a;
    return new Program(IDL, (_a = params === null || params === void 0 ? void 0 : params.programId) !== null && _a !== void 0 ? _a : SPL_STAKE_POOL_PROGRAM_ID, params === null || params === void 0 ? void 0 : params.provider, new SplStakePoolCoder(IDL));
}
const IDL = {
    version: "0.7.0",
    name: "spl_stake_pool",
